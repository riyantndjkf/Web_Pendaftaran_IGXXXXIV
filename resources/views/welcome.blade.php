...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <body class="bg-[#14191A] text-white">
    ...
    <section class="bg-[#14191A] py-16 relative" style="background-image: url('{{ asset('images/Background_Timeline.png') }}'); background-size: cover; background-position: center;">
        ...
        <!-- Prizes Section -->
    <section class="bg-[#14191A] py-16 relative flex flex-col justify-start items-center h-screen" style="background-image: url('{{ asset('images/Background_Prizes.png') }}'); background-size: cover; background-position: center;">
        <div class="container mx-auto text-center p-4">
